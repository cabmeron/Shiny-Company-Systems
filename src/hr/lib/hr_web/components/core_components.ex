defmodule HrWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HrWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HrWeb.Gettext, "errors", msg, opts)
    end
  end
